...
exports.LISTING_PRESETS = {
    ...
    ULTRA_PREMIUM: Object.assign(Object.assign({}, PREMIUM_LISTING), { netBorrowLimitPerWindowQuote: toNative(125000, 6).toNumber(), borrowWeightScaleStartQuote: toNative(500000, 6).toNumber(), depositWeightScaleStartQuote: toNative(500000, 6).toNumber(), preset_name: "AAA", preset_key: "ULTRA_PREMIUM", preset_target_amount: 250000, loanFeeRate: 0.0005, loanOriginationFeeRate: 0.0005 }),
    //Price impact on $100,000 swap lower then 1%
    PREMIUM: Object.assign({}, PREMIUM_LISTING),
    //Price impact on $20,000 swap lower then 1%
    MID: Object.assign(Object.assign({}, PREMIUM_LISTING), { maintAssetWeight: 0.75, initAssetWeight: 0.5, maintLiabWeight: 1.2, initLiabWeight: 1.4, liquidationFee: 0.1, loanFeeRate: 0.02, netBorrowLimitPerWindowQuote: toNative(20000, 6).toNumber(), borrowWeightScaleStartQuote: toNative(50000, 6).toNumber(), depositWeightScaleStartQuote: toNative(50000, 6).toNumber(), groupInsuranceFund: true, preset_name: "A", preset_key: "MID", preset_target_amount: 20000, loanOriginationFeeRate: 0.002 }),
    //Price impact on $5,000 swap lower then 1%
    MEME: Object.assign(Object.assign({}, PREMIUM_LISTING), { loanOriginationFeeRate: 0.005, maintAssetWeight: 0, initAssetWeight: 0, loanFeeRate: 0.05, maintLiabWeight: 1.3, initLiabWeight: 1.6, liquidationFee: 0.1, netBorrowLimitPerWindowQuote: toNative(5000, 6).toNumber(), borrowWeightScaleStartQuote: toNative(20000, 6).toNumber(), depositWeightScaleStartQuote: toNative(20000, 6).toNumber(), groupInsuranceFund: false, preset_name: "BB", preset_key: "MEME", preset_target_amount: 5000, maxStalenessSlots: 1000, oracleConfFilter: 1000 }),
    //Price impact on $1,000 swap lower then 1%
    SHIT: Object.assign(Object.assign({}, PREMIUM_LISTING), { loanFeeRate: 0.075, loanOriginationFeeRate: 0.0075, maintAssetWeight: 0, initAssetWeight: 0, maintLiabWeight: 1.4, initLiabWeight: 1.8, liquidationFee: 0.1, netBorrowLimitPerWindowQuote: toNative(5000, 6).toNumber(), borrowWeightScaleStartQuote: toNative(20000, 6).toNumber(), depositWeightScaleStartQuote: toNative(20000, 6).toNumber(), groupInsuranceFund: false, preset_name: "B", preset_key: "SHIT", preset_target_amount: 1000, maxStalenessSlots: 10000, oracleConfFilter: 1000 }),
