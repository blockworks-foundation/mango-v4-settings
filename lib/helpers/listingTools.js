...
const getPresetWithAdjustedNetBorrows = (tier, currentTotalDepositsInUsdc) => {
...
const getPresetWithAdjustedDepositLimit = (tier, tokenPrice) => {
    return Object.assign(Object.assign({}, tier), { depositLimit: Math.ceil(tier.depositLimitNotional / tokenPrice) });
};
