...
const getPresetWithAdjustedNetBorrows = (tier, uiDeposits, uiPrice) => {
    const newNetBorrowLimitPerWindowQuote = Math.max(10000, Math.min(uiDeposits * uiPrice, 300000) / 3 +
